...
/* === Tambahkan blok ini (jangan dobel) === */
$USER_ID = (int)($_SESSION['user_id'] ?? 0);   // dipakai di semua halaman jurnalis

function scalar(mysqli $c, string $sql){       // helper ambil 1 nilai (COUNT/SUM/...)
  $res = $c->query($sql);
  if(!$res){ return 0; }
  $row = $res->fetch_row();
...
<main class="main">
  <header class="header">
    ...
    <div class="header-right">
      <!-- ganti 'AN' hardcode jadi inisial dinamis -->
